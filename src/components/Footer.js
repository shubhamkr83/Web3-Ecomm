            ...
            <footer >
                <section className="text-gray-300 body-font">
                    <div className="container px-5 py-6 mx-auto flex items-center md:flex-row flex-col">
                        <div className="flex flex-col md:pr-10 md:mb-0 mb-6 pr-0 w-full md:w-auto md:text-left text-center">
                            <h2 className="text-3xl text-indigo-500 font-normal title-font mb-1">Shopperia</h2>
                            <h1 className=" title-font text-gray-500">The e-commerce platform for every niche</h1>
                        </div>
                        <div className="flex md:ml-auto md:mr-0 mx-auto items-center flex-shrink-0 space-x-4 ">
                            <button className="inline-flex py-2 px-3 rounded-lg items-center hover:bg-purple-700 focus:outline-none bg-gray-600">
                                ...
                                <span className="ml-3 flex items-start flex-col leading-none">
                                    ...
                                    <span className="title-font text-white font-semibold">Google Play</span>
                                </span>
                            </button>
                            <button className=" inline-flex py-2 px-3 rounded-lg items-center hover:bg-purple-700 focus:outline-none bg-gray-600">
                                ...
                                <span className="ml-3 flex items-start flex-col leading-none">
                                    ...
                                    <span className="title-font text-white font-semibold">App Store</span>
                                </span>
                            </button>
                        </div>
                    </div>
                ...
                <div className="bg-gray-100">
                    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                        <p className="text-gray-500 text-sm text-center sm:text-left">© 2023 Shopperia —
